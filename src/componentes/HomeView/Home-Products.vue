    ...
    <div class="container">
        ...
        <div class="all-products">
            ...
            <div class="lista-produtos">
                <div v-if="produtosSelecionado.length === 0" class="nenhum-produto MS-Reference">Nenhum produto disponível no momento</div>
                ...
                <div v-else class="lista-produtos">
                    <div v-for="p in produtosSelecionado" :key="p.id" class="produto">
                        ...
                        <button @click="$router.push({ name: 'Produto', params: { id: p.id } })" class="button-de-comprar">Comprar</button>
